...
public class XmlXPath {
    private static final String NASA_FILE_PATH = "/home/es/Sites/swe/data-science-assignment/src/main/resources/NASAtemperatureAbnormal.xml";
    ...
    private static XmlXPath instance;

    public static XmlXPath getInstance() throws Exception {
        if (instance == null) {
            instance = new XmlXPath();
